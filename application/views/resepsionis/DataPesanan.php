   ...
   <body>
      ...
      <div class="card-header d-flex justify-content-between">
        ...
        <div class="form-group col-md-4">
          ...
          <input class="form-control mr-sm-2" style="margin: 0px px 0px 0px" type="search" placeholder="Search" aria-label="Search"  onkeyup="myTableNameD()" id="MynameD">
        ...
        <div class="form-group col-md-4">
          ...
          <div class="d-flex justify-content-start" style="margin-right:20px;">
          <input class="form-control mr-sm-2" style="margin: 0px px 0px 0px" type="search" placeholder="Search" aria-label="Search"  onkeyup="myKodReffD()" id="MyreffD">
          <button class="btn btn-outline-primary" style="margin: 0px 0px 0px 5px" type="button">Search</button>
          </div>
        </div>
    ...
    <h3 class="mt-3 text-center" id="DataPesanan" style="">Maaf belum ada riwayat dilakukan</h3>
    <?php else :?>
      <table class="table table-bordered table-striped" id="MytableD">
        <thread>
          <tr>
            <th style=""></th>
          ...
          <tbody>
            <?php foreach($datapesanan as $data):?>
              ...
              <td><?= $data->KodReff?></td>
              <td><?= $data->status?></td>
              <td><button type="submit" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal<?= $data->id_pemesanan?>">Ubah Status</button></td>
              <!-- Modal -->
